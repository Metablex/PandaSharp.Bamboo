...
{
    [TestFixture]
    internal sealed class ArtifactsOfPlanRequestTest : RequestBaseTest<ArtifactsOfPlanRequest, ArtifactListResponse>
    {
        ...
        private new ArtifactsOfPlanRequest CreateRequest()
        {
