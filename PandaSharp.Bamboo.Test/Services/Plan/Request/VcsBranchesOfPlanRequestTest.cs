...
{
    [TestFixture]
    internal sealed class VcsBranchesOfPlanRequestTest : RequestBaseTest<VcsBranchesOfPlanRequest, VcsBranchListResponse>
    {
        ...
        private new VcsBranchesOfPlanRequest CreateRequest()
        {
