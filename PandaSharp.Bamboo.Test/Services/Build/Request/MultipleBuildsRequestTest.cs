...
{
    [TestFixture]
    internal sealed class MultipleBuildsRequestTest : RequestBaseTest<MultipleBuildsRequest, BuildListResponse>
    {
        ...
        private MultipleBuildsRequest CreateRequest(string projectKey = ProjectKey, string planKey = PlanKey)
        {
